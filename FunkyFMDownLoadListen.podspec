#
# Be sure to run `pod lib lint FunkyFMDownLoadListen.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FunkyFMDownLoadListen.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'FunkyFMDownLoadListen' => ['FunkyFMDownLoadListen/Assets/*.png']
  # }
